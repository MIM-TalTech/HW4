...
using HW4.Aids;
using HW4.Tests.Pages.Extensions;
...
namespace HW4.Tests
{
    internal class htmlHelperMock<TModel> : IHtmlHelper<TModel>
    {
        ...
        public IHtmlContent TextAreaFor<TResult>(Expression<Func<TModel, TResult>> expression,
            int rows, int columns, object htmlAttributes) => new htmlContentMock("TextAreaFor");
        

        public IHtmlContent TextBoxFor<TResult>(Expression<Func<TModel, TResult>> expression,
            string format, object htmlAttributes) => new htmlContentMock("TextBoxFor");
        

        public IHtmlContent ValidationMessageFor<TResult>(Expression<Func<TModel, TResult>> expression,
            string message, object htmlAttributes, string tag) => new htmlContentMock("ValidationMessageFor");


        public string ValueFor<TResult>(Expression<Func<TModel, TResult>> expression, string format) => "ValueFor";
        ...
        public IHtmlContent ValidationMessage(string expression,
            string message, object htmlAttributes, string tag) => new htmlContentMock("ValidationMessageFor");
